% Created by tikzDevice version 0.12.5 on 2024-01-22 21:01:26
...
\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] ( 60.49, 98.88) -- ( 71.29, 98.88);
\definecolor{fillColor}{RGB}{255,165,0}

\path[fill=fillColor] ( 65.89, 91.68) circle (  1.35);
\definecolor{fillColor}{RGB}{0,0,255}

\path[fill=fillColor] ( 65.89, 84.48) circle (  1.35);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.60] at ( 76.69, 96.81) {arith. Mittel};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.60] at ( 76.69, 89.61) {UB genutzt};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.60] at ( 76.69, 82.41) {UB nicht genutzt};
\end{scope}
\begin{scope}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (391.42,224.20) {\bfseries Score Jetzt};
...
\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] (313.44, 98.88) -- (324.24, 98.88);
\definecolor{fillColor}{RGB}{255,165,0}

\path[fill=fillColor] (318.84, 91.68) circle (  1.35);
\definecolor{fillColor}{RGB}{0,0,255}

\path[fill=fillColor] (318.84, 84.48) circle (  1.35);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.60] at (329.64, 96.81) {arith. Mittel};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.60] at (329.64, 89.61) {UB genutzt};

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.60] at (329.64, 82.41) {UB nicht genutzt};
\end{scope}
\end{tikzpicture}
