...
% PDF einfügen
\begin{figure}[h]
	\includepdf[pages=1, pagecommand={\thispagestyle{pdfpages}}, offset=0.1cm -2.4cm]{FinalSeite1.pdf}
\end{figure}
% Zurücksetzen auf das Standard-Seitenlayout für den Rest des Dokuments
\pagestyle{plain}
\newpage
\begin{figure}[h]
	\includepdf[pages=1, pagecommand={\thispagestyle{pdfpages}}, offset=0cm -0.5cm]{Final.pdf}
\end{figure}
\newpage
\begin{figure}[h]
	\includepdf[pages=1, pagecommand={\thispagestyle{pdfpages}}, offset=0.1cm -1.3cm]{Final8.pdf}
\end{figure}
\newpage
\begin{figure}[h]
	\includepdf[pages=2, pagecommand={\thispagestyle{pdfpages}}, offset=0.1cm -2.4cm]{Final8.pdf}
\end{figure}
\newpage
\subsection{Anteile}
\begin{table}[h]
...
\vspace{-4cm}
\begin{figure}[h]
	\includepdf[pages=1, pagecommand={\thispagestyle{pdfpages}}, offset=0.2cm 4.3cm, scale=0.91] {sankey.pdf}
\end{figure}
