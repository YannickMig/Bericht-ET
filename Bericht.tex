...
\begin{figure}[htb]
Von großem Interesse war in unserer Analyse die Gesamtzufriedenheit der Studenten mit den Lernorten. Diese latente Variable haben wir wie bereits erwähnt mit dem "Score" repräsentiert.
...
In Figure 1 wird der Score-Vorher mit dem Score-Jetzt durch zwei Streudiagramme verglichen.
...
Direkt erkennbar ist, dass die Punkte im linken Diagramm deutlich höher und somit näher an der 1. liegen als die Punkte im Score-Jetzt Diagramm.
...
Grob erscheint es auch so, als würden die Punkte im Streudiagramm zu Score-Jetzt mehr streuen, als die im "Score-Vorher".
...
\begin{figure}
	\vspace{-1.5cm}
	\centering \input{Nutzung.tex}
	\vspace{-1cm}
	\caption{Lernortnutzung}
\end{figure}

\includepdf[pages=1] {sankeyNetwork.pdf}
