...
Die Grundgesamtheit setzt sich aus allen Studierenden der Technischen Universität Dortmund zusammen, die mindestens seit dem Sommersemester 2023 studieren. Insgesamt handelt es sich um 25 169 Personen.\cite Es wurden 141 Fragebögen verteilt, von denen 138 ausgewertet werden konnten. Zwei Fragebögen wurden entfernt, da diese leer abgegeben wurden. Des Weiteren hat eine Person erst seit dem Wintersemester 2024 studiert. Dieser Fragebogen wurde ebenfalls aussortiert. \\
...
\begin{figure}[h]
 \input{Lernorte.tex}
 \vspace{0.2cm}
 \caption{Zeitlicher Vergleich der Lernortnutzung}
\end{figure}
\newpage
...
\begin{table}[h]
	\begin{tabular}{c|ccccccc}
		& \begin{tabular}[c]{@{}c@{}}Zeit-\\ überbrückung\end{tabular} & Abgaben & \begin{tabular}[c]{@{}c@{}}Vor-/\\Nachbereitung\end{tabular} & \begin{tabular}[c]{@{}c@{}}Gruppen-\\ arbeiten\end{tabular} & Klausuren & Abschlussarbeiten \\ \hline 
		\\[-0.2cm]
		Anzahl & 57            & 101             & 74                          & 83                     & 76                 & 22    \\
	\end{tabular}
	\vspace{0.15cm}
	\caption{Gründe der Lernortnutzung}
	\vspace{-0.15cm}
\end{table}
\begin{figure}[h]
	...
	Die erhobenen Daten geben auch eine ungefähre Vorstellung davon, wie viel Zeit die Befragten an den Lernorten der TU verbringen.
...
Es scheint, dass das negative Meinungsbild auch bei den Verantwortlichen der TU Dortmund angekommen ist, da diese in der Zwischenzeit einen weiteren Lernort in der Innenstadt geplant und eröffnet haben und nun in der App der TU darauf aufmerksam machen.
\section{Reflexion}
...
\newpage
Ich zitierte etwas. Test. \hyperref[seitenverweis]{$^2$}
\newpage
