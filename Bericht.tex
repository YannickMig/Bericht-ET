...
In Bezug auf unsere Forschungsfragen kann also abschließend festgestellt werden, dass die Veränderungen zum Zeitpunkt der Erhebung nicht ausreichend sind, und die allgemeine Zufriedenheit mit den neu geschaffenen Lernmöglichkeiten nicht ausreichend ist.
...
\vspace{-2cm}
\begin{figure}[h]
	\includepdf[pages=1, offset=0.2cm 3cm] {sankey.pdf}
\end{figure}
\end{document}
