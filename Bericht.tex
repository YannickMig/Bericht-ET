...
Deutlich erkennbar ist, dass die Universitätsbibliothek (UB) im vergangen Semester am häufigsten genutzt wurde. Die UB wurde von 90 der 138 Befragten angegeben.\\
...
\begin{figure}[h]
	\vspace{0cm}
	\centering \input{Nutzung.tex}[ scale = 0.2]
